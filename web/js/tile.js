...
class Ladder extends Tile {
    ...
    entity_interact(entity, action) { //This will start or stop climbing. the actual motion is handled by the player object
